...
---Check what multiplexer we are running
---@return "tmux"|"herdr"| "" string The multiplexer bing run
local get_multiplexer = function()
  local tmux = vim.env.TMUX and vim.env.TMUX ~= ""
  local herdr = vim.env.HERDR_SOCKET_PATH and vim.env.HERDR_SOCKET_PATH ~= ""

  local value = (tmux and "tmux") or (herdr and "herdr") or ""
